...
<>
        ...
        <a href='https://infinite-crag-79632.herokuapp.com/'><img src={'/img/Screen.png'} style={{marginRight: '20px'}} height='200px' width='350px'></img></a>  
        ...
        <div style={{display: 'inline-block'}}>
        <a href='https://stark-taiga-64747.herokuapp.com/'><img src={'/img/tisDa.png'} height='270px' width='350px'></img></a>
